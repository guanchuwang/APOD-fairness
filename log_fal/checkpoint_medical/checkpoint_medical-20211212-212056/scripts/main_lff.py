...
class Agent:
    ...
    def clf_body_init(self):
        ...
        self.optimizer_body_B = torch.optim.Adam(self.clf_body_B.parameters(), lr=1e-3)
        self.optimizer_body_D = torch.optim.Adam(self.clf_body_D.parameters(), lr=1e-3)
    ...
    def clf_head_init(self):
        ...
        self.optimizer_head_B = torch.optim.Adam(self.clf_head_B.parameters(), lr=self.clf_body_learn_rate)
        self.optimizer_head_D = torch.optim.Adam(self.clf_head_D.parameters(), lr=self.clf_body_learn_rate)
    ...
    def fit(self, run_num):
        ...
        self.clf_B_optimizer = torch.optim.Adam([{'params': self.clf_head_B.parameters()},
                                                 {'params': self.clf_body_B.parameters()}], lr=self.clf_body_learn_rate)
        self.clf_D_optimizer = torch.optim.Adam([{'params': self.clf_head_D.parameters()},
                                                 {'params': self.clf_body_D.parameters()}], lr=self.clf_body_learn_rate)
