...
# test_hyperparam_fname = "./log/checkpoint_medical/checkpoint_medical-20210626-214801/medical.json" # apd lambda 0.15
...
# test_hyperparam_fname = "./log/checkpoint_bank/checkpoint_bank-20210626-212445/bank.json" # 30 lambda 0.6
...
# default
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-162812/default.json" # lambda 1
...
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-165058/default.json" # lambda 0.01
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-165624/default.json" # lambda 0.001
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-180238/default.json" # lambda 0.005
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-180800/default.json" # lambda 0.0008
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-175718/default.json" # lambda 5
# test_hyperparam_fname = "./log/checkpoint_default/checkpoint_default-20210706-182950/default.json" # lambda 10
...
if __name__ == "__main__":
    ...
    save_checkpoint(hyperparam["root_log_dir"] + "/test_measures.pth.tar",
                    ...
                    x_data=list(range(hyperparam["warmup_labels"] * 2 + 1, agent.label_budget + 1)),
                    )
    ...
    mean_vallina_tpr0 = 1 - mean_vallina_fnr0
    mean_vallina_tpr1 = 1 - mean_vallina_fnr1

    # print(np.array([x['fpr_diff'] for x in vallina_measures_buffer]), np.array([x['fnr_diff'] for x in vallina_measures_buffer]))
    print(mean_vallina_tpr1 - mean_vallina_tpr0,
            mean_vallina_fpr1 - mean_vallina_fpr0,
            mean_vallina_tpr1 - mean_vallina_tpr0 + (mean_vallina_fpr1 - mean_vallina_fpr0))

    group00_size = (agent.y_test[agent.z_test == 0] == 0).sum()
    group01_size = (agent.y_test[agent.z_test == 0] == 1).sum()
    group10_size = (agent.y_test[agent.z_test == 1] == 0).sum()
    group11_size = (agent.y_test[agent.z_test == 1] == 1).sum()
    print(group00_size, group01_size, group10_size, group11_size)
