...
# test_hyperparam_fname = "./log/checkpoint_adult/checkpoint_adult-20210623-215938/adult_preprocess.json" # Best
# test_hyperparam_fname = "./log/checkpoint_adult/checkpoint_adult-20210624-110526/adult_mengnan.json" # Best
...
# test_hyperparam_fname = "./log/checkpoint_medical/checkpoint_medical-20210624-113837/medical.json" # apd lambda 0.001
...
for run_num in range(5): # total_run_num):
